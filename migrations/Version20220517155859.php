...
CREATE OR REPLACE VIEW public.vw_cumulative_pottery_sheet
 ...
 SELECT cumulative_pottery_sheet.id,
    ...
    cumulative_pottery_sheet.number,
    ...
    cumulative_pottery_sheet.fire_ware_non_diagnostic_count,
    cumulative_pottery_sheet.fire_ware_diagnostic_count,
    ...
    ( SELECT cumulative_pottery_sheet.common_ware_non_diagnostic_count + cumulative_pottery_sheet.common_ware_diagnostic_count + cumulative_pottery_sheet.fire_ware_non_diagnostic_count + cumulative_pottery_sheet.fire_ware_diagnostic_count + cumulative_pottery_sheet.coarse_ware_non_diagnostic_count + cumulative_pottery_sheet.coarse_ware_diagnostic_count + cumulative_pottery_sheet.kitchen_ware_non_diagnostic_count + cumulative_pottery_sheet.kitchen_ware_diagnostic_count) AS cumulative_ware_count,
...
(
	...
	fire_ware_non_diagnostic_count,
	fire_ware_diagnostic_count,
...
(
	...
	NEW.fire_ware_non_diagnostic_count,
	NEW.fire_ware_diagnostic_count,
...
UPDATE public.cumulative_pottery_sheet
	...
	fire_ware_non_diagnostic_count=NEW.fire_ware_non_diagnostic_count, 
	fire_ware_diagnostic_count=NEW.fire_ware_diagnostic_count, 
