...
final class Version20220517155858 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE voc__subperiod_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE cumulative_pottery_sheet (id INT NOT NULL, su_id INT NOT NULL, date DATE NOT NULL, compiler VARCHAR(255) NOT NULL, notes TEXT DEFAULT NULL, common_ware_non_diagnostic_count SMALLINT DEFAULT 0 NOT NULL, common_ware_diagnostic_count SMALLINT DEFAULT 0 NOT NULL, fine_ware_non_diagnostic_count SMALLINT DEFAULT 0 NOT NULL, fine_ware_diagnostic_count SMALLINT DEFAULT 0 NOT NULL, coarse_ware_non_diagnostic_count SMALLINT DEFAULT 0 NOT NULL, coarse_ware_diagnostic_count SMALLINT DEFAULT 0 NOT NULL, kitchen_ware_non_diagnostic_count SMALLINT DEFAULT 0 NOT NULL, kitchen_ware_diagnostic_count SMALLINT DEFAULT 0 NOT NULL, subperiod_epn_count SMALLINT DEFAULT 0 NOT NULL, subperiod_has_count SMALLINT DEFAULT 0 NOT NULL, subperiod_sam_count SMALLINT DEFAULT 0 NOT NULL, subperiod_hal_count SMALLINT DEFAULT 0 NOT NULL, subperiod_nub_count SMALLINT DEFAULT 0 NOT NULL, subperiod_lca_count SMALLINT DEFAULT 0 NOT NULL, subperiod_lca1_count SMALLINT DEFAULT 0 NOT NULL, subperiod_lca2_count SMALLINT DEFAULT 0 NOT NULL, subperiod_lca3_count SMALLINT DEFAULT 0 NOT NULL, subperiod_lca4_count SMALLINT DEFAULT 0 NOT NULL, subperiod_lca5_count SMALLINT DEFAULT 0 NOT NULL, subperiod_sur_count SMALLINT DEFAULT 0 NOT NULL, subperiod_emt_count SMALLINT DEFAULT 0 NOT NULL, subperiod_emt0_count SMALLINT DEFAULT 0 NOT NULL, subperiod_emt1_count SMALLINT DEFAULT 0 NOT NULL, subperiod_emt2_count SMALLINT DEFAULT 0 NOT NULL, subperiod_emt3_count SMALLINT DEFAULT 0 NOT NULL, subperiod_emt4_count SMALLINT DEFAULT 0 NOT NULL, subperiod_emt5_count SMALLINT DEFAULT 0 NOT NULL, subperiod_mba_count SMALLINT DEFAULT 0 NOT NULL, subperiod_mba1_count SMALLINT DEFAULT 0 NOT NULL, subperiod_mba2_count SMALLINT DEFAULT 0 NOT NULL, subperiod_lba1_count SMALLINT DEFAULT 0 NOT NULL, subperiod_lba2_count SMALLINT DEFAULT 0 NOT NULL, subperiod_ira1_count SMALLINT DEFAULT 0 NOT NULL, subperiod_ira2_count SMALLINT DEFAULT 0 NOT NULL, subperiod_hel_count SMALLINT DEFAULT 0 NOT NULL, subperiod_par_count SMALLINT DEFAULT 0 NOT NULL, subperiod_byz_count SMALLINT DEFAULT 0 NOT NULL, subperiod_sas_count SMALLINT DEFAULT 0 NOT NULL, subperiod_isl_count SMALLINT DEFAULT 0 NOT NULL, subperiod_isl1_count SMALLINT DEFAULT 0 NOT NULL, subperiod_isl2_count SMALLINT DEFAULT 0 NOT NULL, subperiod_isl3_count SMALLINT DEFAULT 0 NOT NULL, subperiod_undetermined_count SMALLINT DEFAULT 0 NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_DB90ABFCBDB1218E ON cumulative_pottery_sheet (su_id)');
        ...
        $this->addSql('CREATE TABLE ecofact (id INT NOT NULL, su_id INT NOT NULL, type_id SMALLINT NOT NULL, preservation_state_id SMALLINT DEFAULT NULL, date DATE NOT NULL, collection_date DATE DEFAULT NULL, number SMALLINT NOT NULL, height DOUBLE PRECISION DEFAULT NULL, width DOUBLE PRECISION DEFAULT NULL, length DOUBLE PRECISION DEFAULT NULL, thickness DOUBLE PRECISION DEFAULT NULL, min_diameter DOUBLE PRECISION DEFAULT NULL, max_diameter DOUBLE PRECISION DEFAULT NULL, weight DOUBLE PRECISION DEFAULT NULL, selected_for_analysis BOOLEAN NOT NULL, compiler VARCHAR(255) NOT NULL, notes TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE grave (id INT NOT NULL, site_id INT NOT NULL, area_id INT NOT NULL, earlier_than_id INT DEFAULT NULL, later_than_id INT DEFAULT NULL, period_id SMALLINT DEFAULT NULL, ritual_id SMALLINT DEFAULT NULL, deposition_id SMALLINT DEFAULT NULL, type_id SMALLINT NOT NULL, preservation_state_id SMALLINT DEFAULT NULL, number SMALLINT NOT NULL, year INT NOT NULL, date DATE NOT NULL, description TEXT DEFAULT NULL, interpretation TEXT DEFAULT NULL, alignment TEXT DEFAULT NULL, summary TEXT DEFAULT NULL, area_supervisor VARCHAR(255) DEFAULT NULL, compiler VARCHAR(255) NOT NULL, building SMALLINT DEFAULT NULL, building_sub_phase CHAR(1) DEFAULT NULL, room VARCHAR(2) DEFAULT NULL, phase SMALLINT DEFAULT NULL, sub_phase CHAR(1) DEFAULT NULL, top_elevation DOUBLE PRECISION DEFAULT NULL, bottom_elevation DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE INDEX IDX_21AEDEE71467A8C6 ON grave (earlier_than_id)');
        $this->addSql('CREATE INDEX IDX_21AEDEE719875ADC ON grave (later_than_id)');
        ...
        $this->addSql('CREATE TABLE media_objects__potteries (id INT NOT NULL, pottery_id INT NOT NULL, media_object_id INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE sample (id INT NOT NULL, su_id INT NOT NULL, strategy_id SMALLINT DEFAULT NULL, type_id SMALLINT NOT NULL, preservation_state_id SMALLINT DEFAULT NULL, date DATE NOT NULL, collection_date DATE DEFAULT NULL, number SMALLINT NOT NULL, quantity SMALLINT NOT NULL, height DOUBLE PRECISION DEFAULT NULL, width DOUBLE PRECISION DEFAULT NULL, length DOUBLE PRECISION DEFAULT NULL, thickness DOUBLE PRECISION DEFAULT NULL, min_diameter DOUBLE PRECISION DEFAULT NULL, max_diameter DOUBLE PRECISION DEFAULT NULL, weight DOUBLE PRECISION DEFAULT NULL, selected_for_analysis BOOLEAN NOT NULL, compiler VARCHAR(255) NOT NULL, notes TEXT DEFAULT NULL, contamination_risk BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE INDEX IDX_2E109A89EC8B7ADE ON small_find (period_id)');
        ...
        $this->addSql('CREATE TABLE su (id INT NOT NULL, site_id INT NOT NULL, area_id INT NOT NULL, grave_id INT DEFAULT NULL, period_id SMALLINT DEFAULT NULL, type_id SMALLINT NOT NULL, preservation_state_id SMALLINT DEFAULT NULL, number INT NOT NULL, year INT NOT NULL, date DATE NOT NULL, description TEXT DEFAULT NULL, interpretation TEXT DEFAULT NULL, summary TEXT DEFAULT NULL, building SMALLINT DEFAULT NULL, building_sub_phase CHAR(1) DEFAULT NULL, room VARCHAR(2) DEFAULT NULL, phase SMALLINT DEFAULT NULL, sub_phase CHAR(1) DEFAULT NULL, top_elevation DOUBLE PRECISION DEFAULT NULL, bottom_elevation DOUBLE PRECISION DEFAULT NULL, area_supervisor VARCHAR(255) DEFAULT NULL, compiler VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE voc__period (id SMALLINT NOT NULL, code VARCHAR(255) NOT NULL, value VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE voc__subperiod (id SMALLINT NOT NULL, period_id SMALLINT NOT NULL, code VARCHAR(255) NOT NULL, value VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_53CD46C5EC8B7ADE ON voc__subperiod (period_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_53CD46C51D775834 ON voc__subperiod (value)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_53CD46C577153098 ON voc__subperiod (code)');
        ...
        $this->addSql('ALTER TABLE pottery ADD CONSTRAINT FK_1A65183978E4D1E7 FOREIGN KEY (subperiod_id) REFERENCES voc__subperiod (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE small_find ADD CONSTRAINT FK_2E109A89EC8B7ADE FOREIGN KEY (period_id) REFERENCES voc__period (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE voc__subperiod ADD CONSTRAINT FK_53CD46C5EC8B7ADE FOREIGN KEY (period_id) REFERENCES voc__period (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document DROP CONSTRAINT FK_D8698A7664DE5A5');
        $this->addSql('ALTER TABLE media_objects__building_room DROP CONSTRAINT FK_A0DA09A664DE5A5');
        ...
        $this->addSql('ALTER TABLE grave DROP CONSTRAINT FK_21AEDEE7F6BD1646');
        ...
        $this->addSql('ALTER TABLE grave DROP CONSTRAINT FK_21AEDEE71467A8C6');
        $this->addSql('ALTER TABLE grave DROP CONSTRAINT FK_21AEDEE719875ADC');
        ...
        $this->addSql('ALTER TABLE grave DROP CONSTRAINT FK_21AEDEE7EC8B7ADE');
        $this->addSql('ALTER TABLE pottery DROP CONSTRAINT FK_1A651839EC8B7ADE');
        $this->addSql('ALTER TABLE small_find DROP CONSTRAINT FK_2E109A89EC8B7ADE');
        $this->addSql('ALTER TABLE su DROP CONSTRAINT FK_65A4BD79EC8B7ADE');
        $this->addSql('ALTER TABLE voc__subperiod DROP CONSTRAINT FK_53CD46C5EC8B7ADE');
        $this->addSql('ALTER TABLE ecofact DROP CONSTRAINT FK_9F00A5DDFE71FA16');
        $this->addSql('ALTER TABLE grave DROP CONSTRAINT FK_21AEDEE7FE71FA16');
        ...
        $this->addSql('ALTER TABLE pottery DROP CONSTRAINT FK_1A65183978E4D1E7');
        $this->addSql('ALTER TABLE small_find DROP CONSTRAINT FK_2E109A8978E4D1E7');
        ...
        $this->addSql('DROP SEQUENCE voc__subperiod_id_seq CASCADE');
        ...
        $this->addSql('DROP TABLE voc__subperiod');
    }
}
