...
if  [ "${WWW_CLIENT_DIR}" = "/path/to/client" ]; then
       WWW_CLIENT_DIR="${ROOT_DIR}"/docker/nginx/client
fi

DOTENV="APP_ENV APP_SECRET POSTGRES_PASSWORD POSTGRES_USER POSTGRES_DB POSTGRES_PORT POSTGRES_DATA_DIR POSTGRES_DUMP_DIR DATABASE_URL WWW_STATIC_DIR WWW_CLIENT_DIR NGINX_HOST NGINX_PORT NGINX_SSL_PORT"
