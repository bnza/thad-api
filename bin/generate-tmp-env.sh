...
DOTENV="APP_ENV APP_SECRET POSTGRES_PASSWORD POSTGRES_USER POSTGRES_DB POSTGRES_PORT POSTGRES_DATA_DIR DATABASE_URL WWW_STATIC_DIR WWW_CLIENT_DIR NGINX_HOST NGINX_PORT NGINX_SSL_PORT"
